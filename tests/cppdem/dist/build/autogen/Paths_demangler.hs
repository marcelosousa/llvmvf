...
bindir     = "/users/msousa/.cabal/bin"
libdir     = "/users/msousa/.cabal/lib/demangler-1.0/ghc-7.0.4"
datadir    = "/users/msousa/.cabal/share/demangler-1.0"
libexecdir = "/users/msousa/.cabal/libexec"
