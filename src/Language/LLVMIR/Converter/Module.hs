         ...
         (let _lhsOetm :: (Map Identifier ([Identifier], [ETm] -> ETm))
              ...
              _lhsOetm =
                  ({-# LINE 87 "src/Language/LLVMIR/Converter/Module.ag" #-}
                   ...
                   {-# LINE 677 "src/Language/LLVMIR/Converter/Module.hs" #-}
                   )
              _lhsOphis =
                  ({-# LINE 89 "src/Language/LLVMIR/Converter/Module.ag" #-}
                   ...
                   {-# LINE 685 "src/Language/LLVMIR/Converter/Module.hs" #-}
                   )
              _self =
                  (:) _hdIself _tlIself
              _lhsOself =
              ...
              _tlOphim =
                  ({-# LINE 77 "src/Language/LLVMIR/Converter/Module.ag" #-}
                   _lhsIphim
                   {-# LINE 694 "src/Language/LLVMIR/Converter/Module.hs" #-}
                   )
         ...
         (let _lhsOetm :: (Map Identifier ([Identifier], [ETm] -> ETm))
              ...
              _lhsOetm =
                  ({-# LINE 85 "src/Language/LLVMIR/Converter/Module.ag" #-}
                   M.empty
                   {-# LINE 710 "src/Language/LLVMIR/Converter/Module.hs" #-}
                   )
              _lhsOphis =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 161 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 1115 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             BlockAddr
         _lhsOself =
...
sem_Constant_CmpConst cc_ =
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 161 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 1131 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             CmpConst _ccIself
         _lhsOself =
...
sem_Constant_ConstantExpr expr_ =
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 161 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 1149 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Constant_GlobalValue gv_ =
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 161 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 1167 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 61 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 1820 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 59 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ...
              {-# LINE 1858 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _bodyOphim =
             ({-# LINE 60 "src/Language/LLVMIR/Converter/Module.ag" #-}
              _bodyIphis
              {-# LINE 1863 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 49 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ...
              {-# LINE 1913 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 48 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 1931 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             Data.Map.empty
         _lhsOself =
    ...
    (let _lhsOetm :: (ETm -> ETm)
         ...
         _lhsOetm =
             ({-# LINE 40 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ...
              {-# LINE 2000 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: (ETm -> ETm)
         ...
         _lhsOetm =
             ({-# LINE 37 "src/Language/LLVMIR/Converter/Module.ag" #-}
              _hdIetm . _tlIetm
              {-# LINE 2117 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             (:) _hdIself _tlIself
         _lhsOself =
    ...
    (let _lhsOetm :: (ETm -> ETm)
         ...
         _lhsOetm =
             ({-# LINE 36 "src/Language/LLVMIR/Converter/Module.ag" #-}
              id
              {-# LINE 2135 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             []
         _lhsOself =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 156 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EVar _nameIself
              {-# LINE 2194 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             Global _nameIself
         _lhsOself =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 157 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EVar _nameIself
              {-# LINE 2212 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             Local _nameIself
         _lhsOself =
    ...
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2407 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
         ...
         _lhsOetm =
             ({-# LINE 123 "src/Language/LLVMIR/Converter/Module.ag" #-}
              let f t = let i = getId _idIetm
                        ...
                        in ELet i o (head t)
              in ([], f)
              {-# LINE 2453 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2458 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Alloca pc_ id_ ty_ align_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2492 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2497 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_And pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2538 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_AtomicRMW pc_ id_ mptr_ opval_ op_ ord_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2583 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_BitCast pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2620 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
    ...
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 115 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ...
              {-# LINE 2659 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2664 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 131 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ...
              in ([], f)
              {-# LINE 2704 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2709 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Cmpxchg pc_ id_ mptr_ cval_ nval_ ord_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2750 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2755 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_CreateThread pc_ args_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2787 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
...
sem_Instruction_ExtractValue pc_ id_ aggr_ idxs_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2821 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2826 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_FAdd pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2862 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2867 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_FCmp pc_ id_ cond_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2907 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2912 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_FDiv pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2952 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 2957 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_FMul pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 2995 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3000 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_FPExt pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3035 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3040 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_FPToSI pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3078 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_FRem pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3190 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3195 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_FSub pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3233 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3238 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_InsertValue pc_ id_ aggr_ ival_ idxs_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3374 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_IntToPtr pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3409 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3414 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_LShr pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3450 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3455 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Load pc_ id_ v_ align_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3490 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
...
sem_Instruction_Mul pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3539 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_MutexInit pc_ rv_ mutex_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3572 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3577 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_MutexLock pc_ rv_ mutex_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3606 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3611 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_MutexUnlock pc_ rv_ mutex_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3645 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_NotifyEvent pc_ event_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3669 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3674 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Or pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3704 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3709 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_PtrToInt pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3786 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Ret pc_ r_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3819 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_SDiv pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3851 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3856 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_SExt pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3891 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3896 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_SIToFP pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 3929 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3934 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_SRem pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 3975 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Select pc_ id_ cond_ valt_ valf_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4019 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Shl pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4062 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Store pc_ ty_ v1_ v2_ align_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 4099 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4104 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Sub pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4147 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Trunc pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4224 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 116 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([getId _dIetm], head)
              {-# LINE 4252 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4257 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_UIToFP pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4334 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_URem pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 4370 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4375 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_WaitEvent pc_ event_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 4427 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4432 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_WaitTime pc_ time_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 4454 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4459 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_Xor pc_ id_ ty_ op1_ op2_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 4491 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
...
sem_Instruction_ZExt pc_ id_ v_ ty_ =
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4536 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: (([Identifier], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 105 "src/Language/LLVMIR/Converter/Module.ag" #-}
              (["-1"], const EBot)
              {-# LINE 4611 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4616 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             []
         _lhsOself =
    ...
    (let _lhsOhtm :: HTm
         ...
         _lhsOhtm =
             ({-# LINE 29 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ...
              {-# LINE 5567 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 71 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ...
              {-# LINE 5916 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ([ETm])
         ...
         _lhsOetm =
             ({-# LINE 65 "src/Language/LLVMIR/Converter/Module.ag" #-}
              _hdIetm : _tlIetm
              {-# LINE 5956 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             (:) _hdIself _tlIself
         _lhsOself =
...
sem_Parameters_Nil =
    (let _lhsOetm :: ([ETm])
         ...
         _lhsOetm =
             ({-# LINE 65 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 5974 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             []
         _lhsOself =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 148 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 6199 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             VoidRet
         _lhsOself =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 165 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 6260 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             ConstantFP _fpIself
         _lhsOself =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 164 "src/Language/LLVMIR/Converter/Module.ag" #-}
              ENum iv_
              {-# LINE 6279 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_SimpleConstant_ConstantPointerNull ty_ =
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 165 "src/Language/LLVMIR/Converter/Module.ag" #-}
              EBot
              {-# LINE 6297 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 152 "src/Language/LLVMIR/Converter/Module.ag" #-}
              _cIetm
              {-# LINE 6804 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             Constant _cIself
         _lhsOself =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 151 "src/Language/LLVMIR/Converter/Module.ag" #-}
              _vIetm
              {-# LINE 6825 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             Id _vIself _tyIself
         _lhsOself =
    ...
    (let _lhsOetm :: ([ETm])
         ...
         _lhsOetm =
             ({-# LINE 144 "src/Language/LLVMIR/Converter/Module.ag" #-}
              _hdIetm : _tlIetm
              {-# LINE 6905 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             (:) _hdIself _tlIself
         _lhsOself =
...
sem_Values_Nil =
    (let _lhsOetm :: ([ETm])
         ...
         _lhsOetm =
             ({-# LINE 144 "src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 6923 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             []
         _lhsOself =
