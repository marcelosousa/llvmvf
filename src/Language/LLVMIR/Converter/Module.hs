...
sem_Instruction_CreateThread pc_ args_ =
    (let _lhsOetm :: (([Label], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 4347 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              []
...
sem_Instruction_MutexInit pc_ rv_ mutex_ =
    (let _lhsOetm :: (([Label], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 4379 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4384 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_NotifyEvent pc_ event_ =
    (let _lhsOetm :: (([Label], [ETm] -> ETm))
         ...
         _lhsOphis =
             ({-# LINE 100 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4506 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
...
sem_Instruction_WaitTime pc_ time_ =
    (let _lhsOetm :: (([Label], [ETm] -> ETm))
         ...
         _lhsOetm =
             ({-# LINE 136 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              ([], const EBot)
              {-# LINE 4528 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _lhsOphis =
             ({-# LINE 100 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              []
              {-# LINE 4533 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 164 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              ENum iv_
              {-# LINE 6317 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 151 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              _vIetm
              {-# LINE 6847 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             Id _vIself _tyIself
         _lhsOself =
    ...
    (let _lhsOetm :: ETm
         ...
         _lhsOetm =
             ({-# LINE 152 "./src/Language/LLVMIR/Converter/Module.ag" #-}
              _cIetm
              {-# LINE 6868 "src/Language/LLVMIR/Converter/Module.hs" #-}
              )
         _self =
             Constant _cIself
         _lhsOself =
