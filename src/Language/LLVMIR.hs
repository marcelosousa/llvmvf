...
{-# LINE 94 "src/Language/LLVMIR.hs" #-}
-- Alias -------------------------------------------------------
data Alias = Alias (Id)
    ...
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 25 "src/Language/LLVMIR/Printer.ag" #-}
              _hdIpp <$> _tlIpp
              {-# LINE 161 "src/Language/LLVMIR.hs" #-}
              )
         _self =
             (:) _hdIself _tlIself
         _lhsOself =
...
sem_Aliases_Nil =
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 25 "src/Language/LLVMIR/Printer.ag" #-}
              P.empty
              {-# LINE 179 "src/Language/LLVMIR.hs" #-}
              )
         _self =
             []
         _lhsOself =
    ...
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 60 "src/Language/LLVMIR/Printer.ag" #-}
              ...
              {-# LINE 597 "src/Language/LLVMIR.hs" #-}
              )
         _self =
...
sem_BasicBlocks_Nil =
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 25 "src/Language/LLVMIR/Printer.ag" #-}
              P.empty
              {-# LINE 656 "src/Language/LLVMIR.hs" #-}
              )
         _self =
             []
         _lhsOself =
    ...
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 36 "src/Language/LLVMIR/Printer.ag" #-}
              ...
              {-# LINE 799 "src/Language/LLVMIR.hs" #-}
              )
         _self =
             DataLayout _sIself
         _lhsOself =
    ...
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 54 "src/Language/LLVMIR/Printer.ag" #-}
              ...
              {-# LINE 1139 "src/Language/LLVMIR.hs" #-}
              )
         _self =
    ...
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 53 "src/Language/LLVMIR/Printer.ag" #-}
              ...
              {-# LINE 1175 "src/Language/LLVMIR.hs" #-}
              )
         _self =
...
sem_Functions_Nil =
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 25 "src/Language/LLVMIR/Printer.ag" #-}
              P.empty
              {-# LINE 1240 "src/Language/LLVMIR.hs" #-}
              )
         _self =
             []
         _lhsOself =
    ...
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 50 "src/Language/LLVMIR/Printer.ag" #-}
              ...
              {-# LINE 1312 "src/Language/LLVMIR.hs" #-}
              )
         _self =
...
sem_Globals_Nil =
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 25 "src/Language/LLVMIR/Printer.ag" #-}
              P.empty
              {-# LINE 1375 "src/Language/LLVMIR.hs" #-}
              )
         _self =
             []
         _lhsOself =
    ...
    (let _lhsOpp :: Doc
         ...
         _lhsOpp =
             ({-# LINE 32 "src/Language/LLVMIR/Printer.ag" #-}
              char '%' <> text _nameIself
              {-# LINE 1456 "src/Language/LLVMIR.hs" #-}
              )
         _self =
             Local _nameIself
         _lhsOself =
...
sem_Identifiers_Nil =
    (let _lhsOself :: Identifiers
     ...
     in  ( _lhsOself))
-- Instruction -------------------------------------------------
data Instruction = AShr (Identifier) (Type) (Value) (Value)
                 | Add (Identifier) (Type) (Value) (Value)
                 | Alloca (Identifier) (Type) (Align)
                 | And (Identifier) (Type) (Value) (Value)
                 ...
                 | LShr (Identifier) (Type) (Value) (Value)
                 | Load (Identifier) (Value) (Align)
                 | Mul (Identifier) (Type) (Value) (Value)
                 | Or (Identifier) (Type) (Value) (Value)
                 ...
                 | Shl (Identifier) (Type) (Value) (Value)
                 ...
                 | Unreachable
                 | Xor (Identifier) (Type) (Value) (Value)
